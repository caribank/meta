...
bibrun:
	pandoc --pdf-engine=xelatex -o bib/bibliography.pdf bib/bibliography.md --bibliography bib/sources.bib --citeproc --csl etc/chicago-author-date-mod.csl
	pandoc -o bib/README.md bib/bibliography.md --bibliography bib/sources.bib --citeproc -t markdown-citations --csl etc/chicago-author-date-mod.csl
